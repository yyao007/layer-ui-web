 ...
 *
 * ```
 * <layer-conversation conversation-id={selectedConversationId}></layer-conversation>
 * ```
 *
 ...
 *
 * ```javascript
 * var conversation = document.createElement('layer-conversation');
 * ```
 *
 * ## Key Properties
 *
 * * layerUI.components.Conversation.conversationId (attribute-name: `conversation-id`): Set what conversation is being viewed
 * * layerUI.components.Conversation.queryId (attribute-name: `query-id`): If your app already has a layer.Query, you can provide it to this widget to render and page through its Messages.  If you don't have a layer.Query instance, this widget will generate one for you.
 *
 ...
 *
 * * {@link layerUI.components.Conversation.Composer#layer-send-message layer-send-message}: User has requested their Message be sent
 * * {@link layerUI.components.misc.Delete#layer-message-deleted layer-message-deleted}: User has requested a Message be deleted
 * * {@link layerUI.components.Conversation.TypingIndicator#layer-typing-indicator-change layer-typing-indicator-change}: Someone in the Conversation has started/stopped typing
 *
 * @class layerUI.components.Conversation
...
LUIComponent('layer-conversation', {
  ...
  properties: {
     ...
     *
     * You may use the layerUI.components.Conversation.query property instead of layerUI.components.Conversation.queryId,
     ...
     * @property {layerUI.components.Conversation.MessageItem} onRenderListItem.widget
     *    One row of the list
