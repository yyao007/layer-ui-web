describe('layer-conversation', function() {
  ...
  beforeEach(function() {
    ...
    el = document.createElement('layer-conversation');
  ...
  describe("The query properties", function() {
    beforeEach(function() {
      testRoot.innerHTML = '<layer-conversation></layer-conversation>';
  ...
  describe("The autoFocusConversation property", function() {
    ...
    it("Should be initializable to false", function() {
      testRoot.innerHTML = '<layer-conversation auto-focus-conversation="false"></layer-conversation>';
      CustomElements.takeRecords();
      el = testRoot.firstChild;
    ...
    it("Should be initializable to true", function() {
      testRoot.innerHTML = '<layer-conversation auto-focus-conversation="true"></layer-conversation>';
      CustomElements.takeRecords();
      el = testRoot.firstChild;
      expect(el.autoFocusConversation).toBe(true);
    });
  ...
  describe("The client property", function() {
    it("Should setup the conversation if there is a conversationId", function() {
      testRoot.innerHTML = '<layer-conversation conversation-id="' + conversation.id + '"></layer-conversation>';
      CustomElements.takeRecords();
      el = testRoot.firstChild;
      spyOn(el, "setupConversation");
      el.client = client;
    ...
    it("Should setup the query if there is a queryId", function() {
      testRoot.innerHTML = '<layer-conversation query-id="' + query.id + '"></layer-conversation>';
      CustomElements.takeRecords();
      el = testRoot.firstChild;
      expect(el.query).toBe(null);
      el.client = client;
  ...
  describe("The created() method", function() {
    ...
    it("Should set a tabIndex of -1 if its unset", function() {
      ...
      // Inverse
      testRoot.innerHTML = '<layer-conversation tabindex="5"></layer-conversation>';
      CustomElements.takeRecords();
      el = testRoot.firstChild;
