describe('layer-user-item', function() {
  ...
  beforeEach(function() {
    ...
    el = document.createElement('layer-user-item');
  ...
  describe("The selected property", function() {
    ...
    it("Should update layer-user-item-selected class", function() {
      expect(el.innerNode.classList.contains('layer-user-item-selected')).toBe(false);
      el.selected = true;
      expect(el.innerNode.classList.contains('layer-user-item-selected')).toBe(true);
      el.selected = false;
      expect(el.innerNode.classList.contains('layer-user-item-selected')).toBe(false);
    });
  ...
  describe("The create() method", function() {
    it("Should initialize selected to true from innerHTML", function() {
      testRoot.innerHTML = '<layer-user-item selected="true"></layer-user-item>';
    ...
    it("Should initialize selected to false from innerHTML", function() {
      testRoot.innerHTML = '<layer-user-item selected="false"></layer-user-item>';
      CustomElements.takeRecords();
    ...
    it("Should initialize selected with default of false from innerHTML", function() {
      testRoot.innerHTML = '<layer-user-item></layer-user-item>';
      CustomElements.takeRecords();
      expect(testRoot.firstChild.selected).toBe(false);
      expect(testRoot.firstChild.nodes.checkbox.checked).toBe(false);
    });
    ...
    it("Should wire up the onChange event handler", function() {
      var called = false;
      el.addEventListener('layer-user-item-selected', function(evt) {
        called = true;
      });
  ...
  describe("The onChange() method", function() {
    it("Should trigger layer-user-item-selected", function() {
      var selectedCalled = false,
        deselectedCalled = false;
      el.addEventListener('layer-user-item-selected', function(evt) {
        selectedCalled = true;
      });
      el.addEventListener('layer-user-item-deselected', function(evt) {
    ...
    it("Should trigger layer-user-item-deselected", function() {
      el.selected = true;
    ...
    it("Should update the layer-user-item-selected if evt.preventDefault not called", function() {
      expect(el.innerNode.classList.contains('layer-user-item-selected')).toBe(false);
      el.nodes.checkbox.click();
      expect(el.innerNode.classList.contains('layer-user-item-selected')).toBe(true);
      el.nodes.checkbox.click();
